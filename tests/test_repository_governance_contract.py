...
def test_core_reset_narrows_gate_d_without_reopening_frozen_foundations() -> None:
    ...
    assert "Gate E closed" in priorities
    ...
    assert "Current phase: **5.1 — Gate E closed; bounded conflict proof technically implemented and owner presentation-reviewed" in phases
