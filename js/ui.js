Warning: truncated output (original token count: 55846)
Total output lines: 5110
...
function renderSlicesPanel(elements, state, map) {
  ...
  const currentSelectedForAdd = getCurrentS…25846 tokens truncated…t activePointerId = null;
