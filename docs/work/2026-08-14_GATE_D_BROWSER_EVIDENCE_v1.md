...
- Capture DOM/pixels precede the separate URL-restoration scenario. Their recorded URL identifies that capture state; later interaction results must not be described as the captured pixels.
