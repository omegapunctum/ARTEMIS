...
- the banner says `ARTEMIS · Source-aware 3D Globe MVP`; a local build is labelled as a non-public generated artifact, while `--public-preview` is explicitly labelled as a public experimental R&D surface;
