...
`ARTEMIS_UI_UX_SYSTEM_v1.0` описывает, **как должен работать интерфейс как система**.

`ARTEMIS_UI_UX_COMPONENT_MAP_v1.0` описывает:
...
1. `ARTEMIS_UI_UX_SYSTEM_v1.0`
2. `ARTEMIS_UI_UX_COMPONENT_MAP_v1.0`

---

# 10. Итог

`ARTEMIS_UI_UX_COMPONENT_MAP_v1.0` фиксирует:
