...
- Current increment: `Temporal Region proof closeout`; #421 implementation merged, Region live publication verified (owner-supplied evidence), user value unvalidated.
