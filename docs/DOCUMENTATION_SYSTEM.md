...
1. executable checks / tests / workflows для фактического runtime/release behavior  
2. `README.md` + canonical docs  
3. working docs  
4. audits  
5. reference  
6. archive
...
- если executable behavior конфликтует с canonical docs, это означает либо code/runtime drift, либо docs drift; конфликт должен быть устранён, а не замаскирован audit note.
...
6. `docs/RESEARCH_SLICE_CONTRACT.md`
7. `docs/EPISTEMIC_CONTRACT.md`
8. `docs/ENTITY_MODEL.md`
9. `docs/CONTENT_GOVERNANCE.md`
10. `docs/AI_POLICY.md`
11. `docs/DATA_CONTRACT.md`
12. `docs/PROJECT_STRUCTURE.md`
13. `docs/PROJECT_PHASES.md`
14. `docs/PRIORITIES.md`
15. затем профильные canonical docs (`CONTROLLED_RELEASE_DECISION`, `ARTEMIS_MASTER_PROMPT`, `RESEARCH_SLICE_SPEC`)
16. только после этого `docs/work/*`, `docs/audits/*`, `docs/reference/*`, `docs/archive/*`
...
- определяет foundation-layer;
- задаёт research slice semantics;
- задаёт epistemic/content/AI governance;
- задаёт entity model;
...
- менять product/data/UI/AI behavior без проверки foundation-layer;
