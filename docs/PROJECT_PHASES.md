...
- Public surfaces: Core landing at `/`, Leonardo Globe at `/globe/`, separate Region public R&D preview at `/region/`, frozen Architecture Atlas compatibility surface at `/atlas/`.
