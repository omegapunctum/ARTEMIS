...
(function () {
  ...
  const dictionary = Object.freeze({
    ...
    'Life periods': 'Периоды жизни',
    'Documented presences': 'Документированные присутствия',
    'Documented presence': 'Документированное присутствие',
    'Record and location details': 'Подробности записи и положения',
    'Related documented context': 'Связанный документированный контекст',
    'Not established': 'Не установлена',
    'Residence range; daily presence not established': 'Период проживания; ежедневное присутствие не установлено',
    'Exact historical position': 'Точное историческое положение',
    'Unknown': 'Неизвестно',
    'Sources supporting this presence': 'Источники, подтверждающие это присутствие',
    'What remains uncertain': 'Что остаётся неопределённым',
    'Prototype coverage': 'Охват прототипа',
    'Why these sources?': 'Почему эти источники?',
    'These sources are included in the current reviewed evidence for this displayed record.': 'Эти источники включены в текущие проверенные свидетельства для показанной записи.',
    ...
    'The corpus is explicitly incomplete. Missing records or geometry must not be interpreted as historical absence.': 'Охват прототипа неполон. Отсутствие записей или геометрии не означает исторического отсутствия.',
    'Range': 'Интервал',
    'Scrub': 'Накопление',
